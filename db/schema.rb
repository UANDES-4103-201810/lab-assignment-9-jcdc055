...
ActiveRecord::Schema.define(version: 20180515170601) do
  ...
  create_table "actormovies", force: :cascade do |t|
    ...
    t.index ["actor_id"], name: "index_actormovies_on_actor_id"
    t.index ["movie_id"], name: "index_actormovies_on_movie_id"
  end
